...
final class SynthesisFilter {
  ...
  private void compute_new_v() {
    float new_v31 = 0.0F, new_v30 = new_v31, new_v29 = new_v30, new_v28 = new_v29, new_v27 = new_v28, new_v26 = new_v27, new_v25 = new_v26, new_v24 = new_v25, new_v23 = new_v24, new_v22 = new_v23, new_v21 = new_v22, new_v20 = new_v21, new_v19 = new_v20, new_v18 = new_v19, new_v17 = new_v18, new_v16 = new_v17, new_v15 = new_v16, new_v14 = new_v15, new_v13 = new_v14, new_v12 = new_v13, new_v11 = new_v12, new_v10 = new_v11, new_v9 = new_v10, new_v8 = new_v9, new_v7 = new_v8, new_v6 = new_v7, new_v5 = new_v6, new_v4 = new_v5, new_v3 = new_v4, new_v2 = new_v3, new_v1 = new_v2, new_v0 = new_v1;
  ...
  private void compute_new_v_old() {
    ...
    new_v[12] = p[7];
    new_v[4] = p[7] + p[5];
    new_v[19] = -(p[7] + p[5]) - p[6];
    new_v[27] = -p[6] - p[7] - p[4];
    new_v[14] = p[15];
    new_v[10] = p[15] + p[11];
    new_v[6] = p[15] + p[11] + p[13];
    new_v[2] = p[15] + p[13] + p[9];
    new_v[17] = -(p[15] + p[13] + p[9]) - p[14];
    float tmp1;
    ...
    new_v[15] = p[15];
    new_v[13] = p[15] + p[7];
    new_v[11] = p[15] + p[7] + p[11];
    new_v[5] = p[15] + p[7] + p[11] + p[5] + p[13];
    new_v[9] = p[15] + p[11] + p[3];
    new_v[7] = p[15] + p[11] + p[3] + p[13];
    new_v[1] = (tmp1 = p[13] + p[15] + p[9]) + p[1];
    new_v[16] = -((tmp1 = p[13] + p[15] + p[9]) + p[1]) - p[14];
    new_v[3] = tmp1 + p[5] + p[7];
    new_v[18] = -(tmp1 + p[5] + p[7]) - p[6] - p[14];
  ...
  private static float[] load_d() {
    try {
      Class<float> elemType = float.class;
