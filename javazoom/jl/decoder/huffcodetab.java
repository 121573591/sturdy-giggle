...
final class huffcodetab {
  ...
  private int[][] val = (int[][])null;
  
  private int treelen;
  
  private static int[][] ValTab0 = new int[][] { { 0, 0 } };
  
  private static int[][] ValTab1 = new int[][] { { 2, 1 }, { 0, 0 }, { 2, 1 }, { 0, 16 }, { 2, 1 }, { 0, 1 }, { 0, 17 } };
  
  private static int[][] ValTab2 = new int[][] { 
      { 2, 1 }, { 0, 0 }, { 4, 1 }, { 2, 1 }, { 0, 16 }, { 0, 1 }, { 2, 1 }, { 0, 17 }, { 4, 1 }, { 2, 1 }, 
      { 0, 32 }, { 0, 33 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 2 }, { 0, 34 } };
  
  private static int[][] ValTab3 = new int[][] { 
      { 4, 1 }, { 2, 1 }, { 0, 0 }, { 0, 1 }, { 2, 1 }, { 0, 17 }, { 2, 1 }, { 0, 16 }, { 4, 1 }, { 2, 1 }, 
      { 0, 32 }, { 0, 33 }, { 2, 1 }, { 0, 18 }, { 2, 1 }, { 0, 2 }, { 0, 34 } };
  
  private static int[][] ValTab4 = new int[][] { { 0, 0 } };
  
  private static int[][] ValTab5 = new int[][] { 
  ...
  private static int[][] ValTab6 = new int[][] { 
  ...
  private static int[][] ValTab7 = new int[][] { 
  ...
  private static int[][] ValTab8 = new int[][] { 
  ...
  private static int[][] ValTab9 = new int[][] { 
  ...
  private static int[][] ValTab10 = new int[][] { 
  ...
  private static int[][] ValTab11 = new int[][] { 
  ...
  private static int[][] ValTab12 = new int[][] { 
  ...
  private static int[][] ValTab13 = new int[][] { 
  ...
  private static int[][] ValTab15 = new int[][] { 
  ...
  private static int[][] ValTab16 = new int[][] { 
  ...
  private static int[][] ValTab24 = new int[][] { 
  ...
  private static int[][] ValTab32 = new int[][] { 
  ...
  private static int[][] ValTab33 = new int[][] { 
  ...
  public static int huffman_decoder(huffcodetab h, int[] x, int[] y, int[] v, int[] w, BitReserve br) {
    ...
    do {
      ...
      if (br.hget1bit() != 0) {
        for (; h.val[point][1] >= 250; point += h.val[point][1]);
        point += h.val[point][1];
      } else {
        for (; h.val[point][0] >= 250; point += h.val[point][0]);
        point += h.val[point][0];
      } 
      level >>>= 1;
