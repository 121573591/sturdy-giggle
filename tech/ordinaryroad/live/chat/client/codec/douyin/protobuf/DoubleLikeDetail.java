...
public final class DoubleLikeDetail extends GeneratedMessageV3 implements DoubleLikeDetailOrBuilder {
  ...
  public static final Descriptors.Descriptor getDescriptor() {
    return Douyin.internal_static_DoubleLikeDetail_descriptor;
  }
  
  protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
    return Douyin.internal_static_DoubleLikeDetail_fieldAccessorTable.ensureFieldAccessorsInitialized(DoubleLikeDetail.class, Builder.class);
  }
  ...
  public void writeTo(CodedOutputStream output) throws IOException {
    if (this.doubleFlag_)
      output.writeBool(1, this.doubleFlag_); 
    if (this.seqId_ != 0)
      output.writeUInt32(2, this.seqId_); 
    if (this.renewalsNum_ != 0)
      output.writeUInt32(3, this.renewalsNum_); 
    if (this.triggersNum_ != 0)
      output.writeUInt32(4, this.triggersNum_); 
  ...
  public int getSerializedSize() {
    ...
    if (this.doubleFlag_)
      size += 
        CodedOutputStream.computeBoolSize(1, this.doubleFlag_); 
    if (this.seqId_ != 0)
      size += 
        CodedOutputStream.computeUInt32Size(2, this.seqId_); 
    if (this.renewalsNum_ != 0)
      size += 
        CodedOutputStream.computeUInt32Size(3, this.renewalsNum_); 
    if (this.triggersNum_ != 0)
      size += 
        CodedOutputStream.computeUInt32Size(4, this.triggersNum_); 
  ...
  public boolean equals(Object obj) {
    ...
    if (getDoubleFlag() != other
      .getDoubleFlag())
      return false; 
    if (getSeqId() != other
      .getSeqId())
      return false; 
    if (getRenewalsNum() != other
      .getRenewalsNum())
      return false; 
    if (getTriggersNum() != other
      .getTriggersNum())
      return false; 
  ...
  public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements DoubleLikeDetailOrBuilder {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return Douyin.internal_static_DoubleLikeDetail_fieldAccessorTable
    ...
    private void buildPartial0(DoubleLikeDetail result) {
      ...
      if ((from_bitField0_ & 0x1) != 0)
        result.doubleFlag_ = this.doubleFlag_; 
      if ((from_bitField0_ & 0x2) != 0)
        result.seqId_ = this.seqId_; 
      if ((from_bitField0_ & 0x4) != 0)
        result.renewalsNum_ = this.renewalsNum_; 
      if ((from_bitField0_ & 0x8) != 0)
        result.triggersNum_ = this.triggersNum_; 
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              continue;
            case 8:
              this.doubleFlag_ = input.readBool();
              this.bitField0_ |= 0x1;
              continue;
            case 16:
              this.seqId_ = input.readUInt32();
              this.bitField0_ |= 0x2;
              continue;
            case 24:
              this.renewalsNum_ = input.readUInt32();
              this.bitField0_ |= 0x4;
              continue;
            case 32:
              this.triggersNum_ = input.readUInt32();
              this.bitField0_ |= 0x8;
              continue;
          } 
