...
public final class Common extends GeneratedMessageV3 implements CommonOrBuilder {
  ...
  public static final Descriptors.Descriptor getDescriptor() {
    return Tiktok.internal_static_Common_descriptor;
  }
  
  protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
    return Tiktok.internal_static_Common_fieldAccessorTable.ensureFieldAccessorsInitialized(Common.class, Builder.class);
  }
  ...
  public void writeTo(CodedOutputStream output) throws IOException {
    ...
    if (this.timestampMs_ != 0L)
      output.writeUInt64(25, this.timestampMs_); 
  ...
  public int getSerializedSize() {
    ...
    if (this.timestampMs_ != 0L)
      size += 
        CodedOutputStream.computeUInt64Size(25, this.timestampMs_); 
  ...
  public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements CommonOrBuilder {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return Tiktok.internal_static_Common_fieldAccessorTable
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 192:
              ...
              continue;
            case 200:
              this.timestampMs_ = input.readUInt64();
