...
public final class LikeMessage extends GeneratedMessageV3 implements LikeMessageOrBuilder {
  ...
  public static final Descriptors.Descriptor getDescriptor() {
    return Tiktok.internal_static_LikeMessage_descriptor;
  }
  
  protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
    return Tiktok.internal_static_LikeMessage_fieldAccessorTable.ensureFieldAccessorsInitialized(LikeMessage.class, Builder.class);
  }
  ...
  public void writeTo(CodedOutputStream output) throws IOException {
    ...
    if ((this.bitField0_ & 0x4) != 0)
      output.writeMessage(8, (MessageLite)getSuffixText()); 
  ...
  public int getSerializedSize() {
    ...
    if ((this.bitField0_ & 0x4) != 0)
      size += 
        CodedOutputStream.computeMessageSize(8, (MessageLite)getSuffixText()); 
    if (this.linkmicGuestUid_ != 0L)
      size += 
  ...
  public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements LikeMessageOrBuilder {
    ...
    protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return Tiktok.internal_static_LikeMessage_fieldAccessorTable
    ...
    private void buildPartial0(LikeMessage result) {
      ...
      if ((from_bitField0_ & 0x20) != 0) {
        result.suffixText_ = (this.suffixTextBuilder_ == null) ? this.suffixText_ : (SuffixText)this.suffixTextBuilder_.build();
        to_bitField0_ |= 0x4;
      } 
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50:
              ...
              continue;
            case 66:
              input.readMessage((MessageLite.Builder)getSuffixTextFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public Builder mergeUser(User value) {
      if (this.userBuilder_ == null) {
        if ((this.bitField0_ & 0x8) != 0 && this.user_ != null && this.user_ != User.getDefaultInstance()) {
