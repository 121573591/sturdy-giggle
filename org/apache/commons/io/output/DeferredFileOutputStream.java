...
public class DeferredFileOutputStream extends ThresholdingOutputStream {
  ...
  protected void thresholdReached() throws IOException {
    ...
    OutputStream fos = Files.newOutputStream(this.outputFile.toPath(), new java.nio.file.OpenOption[0]);
    try {
  ...
  public InputStream toInputStream() throws IOException {
    ...
    return Files.newInputStream(this.outputFile.toPath(), new java.nio.file.OpenOption[0]);
  }
  ...
  public void writeTo(OutputStream outputStream) throws IOException {
    ...
    if (isInMemory()) {
      ...
      try (InputStream fis = Files.newInputStream(this.outputFile.toPath(), new java.nio.file.OpenOption[0])) {
