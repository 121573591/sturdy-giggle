...
public class FileFilterUtils {
  ...
  public static File[] filter(IOFileFilter filter, File... files) {
    ...
    return (File[])((List)filterFiles(filter, Stream.of(files), (Collector)Collectors.toList())).toArray((Object[])FileUtils.EMPTY_FILE_ARRAY);
  }
  ...
  public static File[] filter(IOFileFilter filter, Iterable<File> files) {
    return filterList(filter, files).<File>toArray(FileUtils.EMPTY_FILE_ARRAY);
  }
  ...
  public static List<File> filterList(IOFileFilter filter, Iterable<File> files) {
    ...
    return filterFiles(filter, StreamSupport.stream(files.spliterator(), false), (Collector)Collectors.toList());
  }
  ...
  public static Set<File> filterSet(IOFileFilter filter, Iterable<File> files) {
    ...
    return filterFiles(filter, StreamSupport.stream(files.spliterator(), false), (Collector)Collectors.toSet());
  }
