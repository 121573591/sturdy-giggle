...
public abstract class FramedataImpl1 implements Framedata {
  ...
  public String toString() {
    return "Framedata{ opcode:" + getOpcode() + ", fin:" + isFin() + ", rsv1:" + isRSV1() + ", rsv2:" + 
      ...
      (this.unmaskedpayload.remaining() > 1000) ? "(too big to display)" : 
      new String(this.unmaskedpayload.array())) + '}';
  }
  ...
  public boolean equals(Object o) {
    ...
    if (this.optcode != that.optcode)
      return false; 
    return (this.unmaskedpayload != null) ? this.unmaskedpayload.equals(that.unmaskedpayload) : (
