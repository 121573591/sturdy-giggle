...
public final class PropertyNode extends Node {
  ...
  public String getKeyName() {
    return (!this.computed && this.key instanceof PropertyKey) ? ((PropertyKey)this.key).getPropertyName() : null;
  }
  
  public Node accept(NodeVisitor<? extends LexicalContext> visitor) {
    if (visitor.enterPropertyNode(this))
      return visitor.leavePropertyNode(
          setKey((Expression)this.key.accept(visitor))
          .setValue((this.value == null) ? null : (Expression)this.value.accept(visitor))
          .setGetter((this.getter == null) ? null : (FunctionNode)this.getter.accept(visitor))
          .setSetter((this.setter == null) ? null : (FunctionNode)this.setter.accept(visitor))); 
    return this;
  }
