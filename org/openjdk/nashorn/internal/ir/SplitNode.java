...
public class SplitNode extends LexicalContextStatement implements CompileUnitHolder {
  ...
  private SplitNode setBody(LexicalContext lc, Block body) {
    if (this.body == body)
      return this; 
    return Node.<SplitNode>replaceInLexicalContext(lc, this, new SplitNode(this, body, this.compileUnit));
  }
  ...
  public SplitNode setCompileUnit(LexicalContext lc, CompileUnit compileUnit) {
    if (this.compileUnit == compileUnit)
      return this; 
    return Node.<SplitNode>replaceInLexicalContext(lc, this, new SplitNode(this, this.body, compileUnit));
  }
