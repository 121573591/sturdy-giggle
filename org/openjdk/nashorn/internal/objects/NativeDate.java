...
public final class NativeDate extends ScriptObject {
  ...
  private static final int[][] firstDayInMonth = new int[][] { { 
  ...
  private static InvokeByName getTO_ISO_STRING() {
    return Global.instance().getInvokeByName(TO_ISO_STRING, () -> new InvokeByName("toISOString", ScriptObject.class, Object.class, new Class[] { Object.class }));
  }
  ...
  public static Object construct(boolean isNew, Object self, Object... args) {
    ...
    NativeDate result = new NativeDate(0.0D);
  ...
  public String safeToString() {
    String str = isValidDate() ? toISOStringImpl(this) : "Invalid Date";
    return "[Date " + str + "]";
  }
  
  public String toString() {
    return isValidDate() ? toString(this) : "Invalid Date";
  }
  ...
  public static Object toJSON(Object self, Object key) {
    ...
    try {
      ...
      throw ECMAErrors.typeError("not.a.function", new String[] { ScriptRuntime.safeToString(func) });
    ...
    if (nd != null && nd.isValidDate()) {
      ...
      switch (format) {
        ...
        case 2:
          tz = nd.getTimeZone();
          utcTime = nd.getTime();
          offset = tz.getOffset((long)utcTime) / 60000;
          inDaylightTime = (offset != tz.getRawOffset() / 60000);
          ...
          sb.append(" GMT").append((offset < 0) ? 45 : 43);
  ...
  private static double dayFromYear(double y) {
    return 365.0D * (y - 1970.0D) + 
      Math.floor((y - 1969.0D) / 4.0D) - 
  ...
  private static int yearFromTime(double t) {
    ...
    if (t2 > t) {
      y--;
    } else if (t2 + 8.64E7D * daysInYear(y) <= t) {
      y++;
    } 
    return y;
  }
  ...
  private static double makeDate(Integer[] d) {
    double time = makeDay(d[0].intValue(), d[1].intValue(), d[2].intValue()) * 8.64E7D;
  ...
  private static NativeDate getNativeDate(Object self) {
    ...
    throw ECMAErrors.typeError("not.a.date", new String[] { ScriptRuntime.safeToString(self) });
  }
