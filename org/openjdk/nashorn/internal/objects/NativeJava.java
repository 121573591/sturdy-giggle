...
public final class NativeJava {
  ...
  public static Object to(Object self, Object obj, Object objType) throws ClassNotFoundException {
    ...
    if (targetClass.isArray())
      try {
        ...
        throw ECMAErrors.typeError(exp, "java.array.conversion.failed", new String[] { targetClass.getName() });
      }  
    ...
    throw ECMAErrors.typeError("unsupported.java.to.type", new String[] { targetClass.getName() });
  }
  ...
  public static NativeArray from(Object self, Object objArray) {
    ...
    throw ECMAErrors.typeError("cant.convert.to.javascript.array", new String[] { objArray.getClass().getName() });
  }
