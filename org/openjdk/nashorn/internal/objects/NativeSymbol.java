...
public final class NativeSymbol extends ScriptObject {
  ...
  static final MethodHandle WRAPFILTER = findOwnMH("wrapFilter", Lookup.MH.type(NativeSymbol.class, new Class[] { Object.class }));
  ...
  private static Symbol getSymbolValue(Object self) {
    ...
    throw ECMAErrors.typeError("not.a.symbol", new String[] { ScriptRuntime.safeToString(self) });
  }
  ...
  public static synchronized Object keyFor(Object self, Object arg) {
    if (!(arg instanceof Symbol))
      throw ECMAErrors.typeError("not.a.symbol", new String[] { ScriptRuntime.safeToString(arg) }); 
