...
public final class JavaAdapterServices {
  ...
  public static ScriptFunction checkFunction(Object callee, String name) {
    ...
    if (JSType.nullOrUndefined(callee))
      return null; 
    throw ECMAErrors.typeError("not.a.function.value", new String[] { name, ScriptRuntime.safeToString(callee) });
  }
  ...
  private static MethodHandle createNoPermissionsInvoker() {
    ...
    InstructionAdapter mv = new InstructionAdapter(cw.visitMethod(9, "invoke", 
          Type.getMethodDescriptor(Type.VOID_TYPE, new Type[] { methodHandleType, objectType }), null, null));
    mv.visitCode();
    ...
    ClassLoader loader = AccessController.<ClassLoader>doPrivileged(() -> new SecureClassLoader(null) {
    ...
    try {
      return MethodHandles.publicLookup().findStatic(Class.forName("NoPermissionsInvoker", true, loader), "invoke", 
          MethodType.methodType(void.class, MethodHandle.class, new Class[] { Object.class }));
