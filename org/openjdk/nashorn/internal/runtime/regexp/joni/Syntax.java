...
public final class Syntax implements SyntaxProperties {
  ...
  public static final Syntax GnuRegex = new Syntax(33543510, 0, -2136997877, 0, new MetaCharTable(92, 0, 0, 0, 0, 0));
  
  public static final Syntax Java = new Syntax(1073206614, 90231, -2136997813, 8, new MetaCharTable(92, 0, 0, 0, 0, 0));
  
  public static final Syntax Perl = new Syntax(2146948438, 196615, -2136997877, 8, new MetaCharTable(92, 0, 0, 0, 0, 0));
