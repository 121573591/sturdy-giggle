  ...
  public static final class CodeGeneratorRequest extends GeneratedMessageV3 implements CodeGeneratorRequestOrBuilder {
    ...
    private CodeGeneratorRequest(GeneratedMessageV3.Builder<?> builder) {
      ...
      this
        ...
        .fileToGenerate_ = LazyStringArrayList.emptyList();
      this.parameter_ = "";
      this.memoizedIsInitialized = -1;
    }
    ...
    public int getSerializedSize() {
      ...
      for (i = 0; i < this.sourceFileDescriptors_.size(); i++)
        size += 
          CodedOutputStream.computeMessageSize(17, (MessageLite)this.sourceFileDescriptors_.get(i)); 
      size += getUnknownFields().getSerializedSize();
      this.memoizedSize = size;
      return size;
    }
    ...
    public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements PluginProtos.CodeGeneratorRequestOrBuilder {
      ...
      private Builder() {
        ...
        this
          .sourceFileDescriptors_ = Collections.emptyList();
      ...
      public Builder mergeFrom(PluginProtos.CodeGeneratorRequest other) {
        ...
        if (this.sourceFileDescriptorsBuilder_ == null) {
          ...
          if (this.sourceFileDescriptorsBuilder_.isEmpty()) {
            ...
            this.sourceFileDescriptors_ = other.sourceFileDescriptors_;
            this.bitField0_ &= 0xFFFFFFF7;
            this.sourceFileDescriptorsBuilder_ = PluginProtos.CodeGeneratorRequest.alwaysUseFieldBuilders ? getSourceFileDescriptorsFieldBuilder() : null;
          } else {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 138:
                ...
                this.sourceFileDescriptorsBuilder_.addMessage((AbstractMessage)m);
                continue;
            } 
            if (!parseUnknownField(input, extensionRegistry, tag))
              done = true; 
      ...
      public DescriptorProtos.FileDescriptorProto.Builder addProtoFileBuilder(int index) {
        return (DescriptorProtos.FileDescriptorProto.Builder)getProtoFileFieldBuilder().addBuilder(index, (AbstractMessage)DescriptorProtos.FileDescriptorProto.getDefaultInstance());
      }
      ...
      private RepeatedFieldBuilderV3<DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> getProtoFileFieldBuilder() {
        if (this.protoFileBuilder_ == null) {
          this.protoFileBuilder_ = new RepeatedFieldBuilderV3(this.protoFile_, ((this.bitField0_ & 0x4) != 0), (AbstractMessage.BuilderParent)getParentForChildren(), isClean());
          this.protoFile_ = null;
        } 
      ...
      public Builder setSourceFileDescriptors(int index, DescriptorProtos.FileDescriptorProto value) {
        if (this.sourceFileDescriptorsBuilder_ == null) {
          ...
          this.sourceFileDescriptorsBuilder_.setMessage(index, (AbstractMessage)value);
        } 
        return this;
      }
      ...
      public Builder setSourceFileDescriptors(int index, DescriptorProtos.FileDescriptorProto.Builder builderForValue) {
        if (this.sourceFileDescriptorsBuilder_ == null) {
          ...
          this.sourceFileDescriptorsBuilder_.setMessage(index, (AbstractMessage)builderForValue.build());
        } 
        return this;
      }
      ...
      public Builder addSourceFileDescriptors(DescriptorProtos.FileDescriptorProto value) {
        if (this.sourceFileDescriptorsBuilder_ == null) {
          ...
          this.sourceFileDescriptorsBuilder_.addMessage((AbstractMessage)value);
        } 
        return this;
      }
      ...
      public Builder addSourceFileDescriptors(int index, DescriptorProtos.FileDescriptorProto value) {
        if (this.sourceFileDescriptorsBuilder_ == null) {
          ...
          this.sourceFileDescriptorsBuilder_.addMessage(index, (AbstractMessage)value);
        } 
        return this;
      }
      ...
      public Builder addSourceFileDescriptors(DescriptorProtos.FileDescriptorProto.Builder builderForValue) {
        if (this.sourceFileDescriptorsBuilder_ == null) {
          ...
          this.sourceFileDescriptorsBuilder_.addMessage((AbstractMessage)builderForValue.build());
        } 
        return this;
      }
      ...
      public Builder addSourceFileDescriptors(int index, DescriptorProtos.FileDescriptorProto.Builder builderForValue) {
        if (this.sourceFileDescriptorsBuilder_ == null) {
          ...
          this.sourceFileDescriptorsBuilder_.addMessage(index, (AbstractMessage)builderForValue.build());
        } 
        return this;
      }
      ...
      public DescriptorProtos.FileDescriptorProto.Builder addSourceFileDescriptorsBuilder() {
        return (DescriptorProtos.FileDescriptorProto.Builder)getSourceFileDescriptorsFieldBuilder().addBuilder(
      ...
      public DescriptorProtos.FileDescriptorProto.Builder addSourceFileDescriptorsBuilder(int index) {
        return (DescriptorProtos.FileDescriptorProto.Builder)getSourceFileDescriptorsFieldBuilder().addBuilder(index, 
            (AbstractMessage)DescriptorProtos.FileDescriptorProto.getDefaultInstance());
      }
      ...
      private RepeatedFieldBuilderV3<DescriptorProtos.FileDescriptorProto, DescriptorProtos.FileDescriptorProto.Builder, DescriptorProtos.FileDescriptorProtoOrBuilder> getSourceFileDescriptorsFieldBuilder() {
        if (this.sourceFileDescriptorsBuilder_ == null) {
          this
            ...
            .sourceFileDescriptorsBuilder_ = new RepeatedFieldBuilderV3(this.sourceFileDescriptors_, ((this.bitField0_ & 0x8) != 0), (AbstractMessage.BuilderParent)getParentForChildren(), isClean());
          this.sourceFileDescriptors_ = null;
        } 
      ...
      public Builder mergeCompilerVersion(PluginProtos.Version value) {
        if (this.compilerVersionBuilder_ == null) {
          if ((this.bitField0_ & 0x10) != 0 && this.compilerVersion_ != null && this.compilerVersion_ != 
