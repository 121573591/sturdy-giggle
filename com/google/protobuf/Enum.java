...
public final class Enum extends GeneratedMessageV3 implements EnumOrBuilder {
  ...
  public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements EnumOrBuilder {
    ...
    private RepeatedFieldBuilderV3<EnumValue, EnumValue.Builder, EnumValueOrBuilder> getEnumvalueFieldBuilder() {
      if (this.enumvalueBuilder_ == null) {
        this.enumvalueBuilder_ = new RepeatedFieldBuilderV3<>(this.enumvalue_, ((this.bitField0_ & 0x2) != 0), getParentForChildren(), isClean());
        this.enumvalue_ = null;
      } 
    ...
    public Builder mergeSourceContext(SourceContext value) {
      if (this.sourceContextBuilder_ == null) {
        if ((this.bitField0_ & 0x8) != 0 && this.sourceContext_ != null && this.sourceContext_ != SourceContext.getDefaultInstance()) {
