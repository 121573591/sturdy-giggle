...
public abstract class GeneratedMessageV3 extends AbstractMessage implements Serializable {
  ...
  public static interface ExtendableMessageOrBuilder<MessageT extends ExtendableMessage<MessageT>> extends MessageOrBuilder {
    Message getDefaultInstanceForType();
    
    <T> boolean hasExtension(ExtensionLite<MessageT, T> param1ExtensionLite);
    
    <T> int getExtensionCount(ExtensionLite<MessageT, List<T>> param1ExtensionLite);
    
    <T> T getExtension(ExtensionLite<MessageT, T> param1ExtensionLite);
    
    <T> T getExtension(ExtensionLite<MessageT, List<T>> param1ExtensionLite, int param1Int);
    
    <T> boolean hasExtension(Extension<MessageT, T> param1Extension);
    
    <T> boolean hasExtension(GeneratedMessage.GeneratedExtension<MessageT, T> param1GeneratedExtension);
    
    <T> int getExtensionCount(Extension<MessageT, List<T>> param1Extension);
    
    <T> int getExtensionCount(GeneratedMessage.GeneratedExtension<MessageT, List<T>> param1GeneratedExtension);
    
    <T> T getExtension(Extension<MessageT, T> param1Extension);
    
    <T> T getExtension(GeneratedMessage.GeneratedExtension<MessageT, T> param1GeneratedExtension);
    
    <T> T getExtension(Extension<MessageT, List<T>> param1Extension, int param1Int);
    
    <T> T getExtension(GeneratedMessage.GeneratedExtension<MessageT, List<T>> param1GeneratedExtension, int param1Int);
  }
  ...
  public static abstract class ExtendableMessage<MessageT extends ExtendableMessage<MessageT>> extends GeneratedMessageV3 implements ExtendableMessageOrBuilder<MessageT> {
    ...
    public final <T> int getExtensionCount(ExtensionLite<MessageT, List<T>> extensionLite) {
      Extension<MessageT, List<T>> extension = (Extension)GeneratedMessageV3.checkNotLite((ExtensionLite)extensionLite);
      verifyExtensionContainingType(extension);
    ...
    protected class ExtensionWriter {
      ...
      public void writeUntil(int end, CodedOutputStream output) throws IOException {
        while (this.next != null && ((Descriptors.FieldDescriptor)this.next.getKey()).getNumber() < end) {
          ...
          if (this.messageSetWireFormat && descriptor
            .getLiteJavaType() == WireFormat.JavaType.MESSAGE && 
            !descriptor.isRepeated()) {
            if (this.next instanceof LazyField.LazyEntry) {
              output.writeRawMessageSetExtension(descriptor
                  .getNumber(), ((LazyField.LazyEntry)this.next)
  ...
  public static abstract class ExtendableBuilder<MessageT extends ExtendableMessage<MessageT>, BuilderT extends ExtendableBuilder<MessageT, BuilderT>> extends Builder<BuilderT> implements ExtendableMessageOrBuilder<MessageT> {
    ...
    private FieldSet<Descriptors.FieldDescriptor> buildExtensions() {
      return (this.extensions == null) ? 
        FieldSet.<Descriptors.FieldDescriptor>emptySet() : 
        this.extensions.buildPartial();
    }
  ...
  private static Method getMethodOrDie(Class<?> clazz, String name, Class<?>... params) {
    try {
      ...
      throw new IllegalStateException("Generated message class \"" + clazz
  ...
  public static final class FieldAccessorTable {
    ...
    private static interface OneofAccessor {
      ...
      Descriptors.FieldDescriptor get(GeneratedMessageV3 param2GeneratedMessageV3);
      
      Descriptors.FieldDescriptor get(GeneratedMessageV3.Builder<?> param2Builder);
    ...
    private static class RealOneofAccessor implements OneofAccessor {
      ...
      RealOneofAccessor(Descriptors.Descriptor descriptor, int oneofIndex, String camelCaseName, Class<? extends GeneratedMessageV3> messageClass, Class<? extends GeneratedMessageV3.Builder<?>> builderClass) {
        this.descriptor = descriptor;
    ...
    private static class SingularFieldAccessor implements FieldAccessor {
      ...
      SingularFieldAccessor(Descriptors.FieldDescriptor descriptor, String camelCaseName, Class<? extends GeneratedMessageV3> messageClass, Class<? extends GeneratedMessageV3.Builder<?>> builderClass, String containingOneofCamelCaseName) {
        ...
        this
          ...
          .hasHasMethod = ((descriptor.getFile().getSyntax() == Descriptors.FileDescriptor.Syntax.EDITIONS && descriptor.hasPresence()) || descriptor.getFile().getSyntax() == Descriptors.FileDescriptor.Syntax.PROTO2 || descriptor.hasOptionalKeyword() || (!this.isOneofField && descriptor.getJavaType() == Descriptors.FieldDescriptor.JavaType.MESSAGE));
    ...
    private static class MapFieldAccessor implements FieldAccessor {
      ...
      MapFieldAccessor(Descriptors.FieldDescriptor descriptor, Class<? extends GeneratedMessageV3> messageClass) {
        ...
        MapFieldReflectionAccessor defaultMapField = getMapField((GeneratedMessageV3)GeneratedMessageV3.invokeOrDie(getDefaultInstanceMethod, null, new Object[0]));
    ...
    private static final class SingularEnumFieldAccessor extends SingularFieldAccessor {
      ...
      SingularEnumFieldAccessor(Descriptors.FieldDescriptor descriptor, String camelCaseName, Class<? extends GeneratedMessageV3> messageClass, Class<? extends GeneratedMessageV3.Builder<?>> builderClass, String containingOneofCamelCaseName) {
        ...
        if (this.supportUnknownEnumValue) {
          ...
          this.setValueMethod = GeneratedMessageV3.getMethodOrDie(builderClass, "set" + camelCaseName + "Value", new Class[] { int.class });
        } 
      }
    ...
    private static final class SingularStringFieldAccessor extends SingularFieldAccessor {
      ...
      SingularStringFieldAccessor(Descriptors.FieldDescriptor descriptor, String camelCaseName, Class<? extends GeneratedMessageV3> messageClass, Class<? extends GeneratedMessageV3.Builder<?>> builderClass, String containingOneofCamelCaseName) {
        ...
        this
          .setBytesMethodBuilder = GeneratedMessageV3.getMethodOrDie(builderClass, "set" + camelCaseName + "Bytes", new Class[] { ByteString.class });
      }
    ...
    private static final class RepeatedMessageFieldAccessor extends RepeatedFieldAccessor {
      ...
      RepeatedMessageFieldAccessor(Descriptors.FieldDescriptor descriptor, String camelCaseName, Class<? extends GeneratedMessageV3> messageClass, Class<? extends GeneratedMessageV3.Builder<?>> builderClass) {
        ...
        this.newBuilderMethod = GeneratedMessageV3.getMethodOrDie(this.type, "newBuilder", new Class[0]);
        this
          .getBuilderMethodBuilder = GeneratedMessageV3.getMethodOrDie(builderClass, "get" + camelCaseName + "Builder", new Class[] { int.class });
      }
  ...
  protected static <V> void serializeIntegerMapTo(CodedOutputStream out, MapField<Integer, V> field, MapEntry<Integer, V> defaultEntry, int fieldNumber) throws IOException {
    ...
    for (int key : keys)
      out.writeMessage(fieldNumber, defaultEntry
          .newBuilderForType().setKey(Integer.valueOf(key)).setValue(m.get(Integer.valueOf(key))).build()); 
  }
  ...
  protected static <V> void serializeLongMapTo(CodedOutputStream out, MapField<Long, V> field, MapEntry<Long, V> defaultEntry, int fieldNumber) throws IOException {
    ...
    for (long key : keys)
      out.writeMessage(fieldNumber, defaultEntry
          .newBuilderForType().setKey(Long.valueOf(key)).setValue(m.get(Long.valueOf(key))).build()); 
  }
  ...
  protected static <V> void serializeStringMapTo(CodedOutputStream out, MapField<String, V> field, MapEntry<String, V> defaultEntry, int fieldNumber) throws IOException {
    ...
    for (String key : keys)
      out.writeMessage(fieldNumber, defaultEntry
          .newBuilderForType().setKey(key).setValue(m.get(key)).build()); 
  }
  ...
  private static <V> void maybeSerializeBooleanEntryTo(CodedOutputStream out, Map<Boolean, V> m, MapEntry<Boolean, V> defaultEntry, int fieldNumber, boolean key) throws IOException {
    if (m.containsKey(Boolean.valueOf(key)))
      out.writeMessage(fieldNumber, defaultEntry
          .newBuilderForType().setKey(Boolean.valueOf(key)).setValue(m.get(Boolean.valueOf(key))).build()); 
  }
  ...
  private static interface OneofAccessor {
    ...
    Descriptors.FieldDescriptor get(GeneratedMessageV3 param1GeneratedMessageV3);
    
    Descriptors.FieldDescriptor get(GeneratedMessageV3.Builder<?> param1Builder);
