...
public final class Api extends GeneratedMessageV3 implements ApiOrBuilder {
  ...
  public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements ApiOrBuilder {
    ...
    private RepeatedFieldBuilderV3<Method, Method.Builder, MethodOrBuilder> getMethodsFieldBuilder() {
      if (this.methodsBuilder_ == null) {
        this.methodsBuilder_ = new RepeatedFieldBuilderV3<>(this.methods_, ((this.bitField0_ & 0x2) != 0), getParentForChildren(), isClean());
        this.methods_ = null;
      } 
    ...
    private RepeatedFieldBuilderV3<Mixin, Mixin.Builder, MixinOrBuilder> getMixinsFieldBuilder() {
      if (this.mixinsBuilder_ == null) {
        this.mixinsBuilder_ = new RepeatedFieldBuilderV3<>(this.mixins_, ((this.bitField0_ & 0x20) != 0), getParentForChildren(), isClean());
        this.mixins_ = null;
      } 
