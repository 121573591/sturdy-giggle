...
public class RepeatedFieldBuilderV3<MType extends AbstractMessage, BType extends AbstractMessage.Builder, IType extends MessageOrBuilder> implements AbstractMessage.BuilderParent {
  ...
  public BType getBuilder(int index) {
    ...
    SingleFieldBuilderV3<MType, BType, IType> builder = this.builders.get(index);
    if (builder == null) {
      AbstractMessage abstractMessage = (AbstractMessage)this.messages.get(index);
      builder = new SingleFieldBuilderV3<>((MType)abstractMessage, this, this.isClean);
  ...
  public RepeatedFieldBuilderV3<MType, BType, IType> setMessage(int index, MType message) {
    ...
    if (this.builders != null) {
      SingleFieldBuilderV3<MType, BType, IType> entry = this.builders.set(index, null);
      if (entry != null)
        entry.dispose(); 
    } 
    onChanged();
  ...
  public RepeatedFieldBuilderV3<MType, BType, IType> addAllMessages(Iterable<? extends MType> values) {
    ...
    for (AbstractMessage abstractMessage : values)
      addMessage((MType)abstractMessage); 
    onChanged();
    incrementModCounts();
    return this;
  }
  ...
  public void remove(int index) {
    ...
    if (this.builders != null) {
      SingleFieldBuilderV3<MType, BType, IType> entry = this.builders.remove(index);
      if (entry != null)
        entry.dispose(); 
    } 
    onChanged();
  ...
  public List<MType> build() {
    ...
    if (!this.isMessagesListMutable) {
      for (int j = 0; j < this.messages.size(); j++) {
        ...
        SingleFieldBuilderV3<MType, BType, IType> builder = this.builders.get(j);
        if (builder != null && 
