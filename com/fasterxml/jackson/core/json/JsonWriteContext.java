...
public class JsonWriteContext extends JsonStreamContext {
  ...
  public JsonWriteContext createChildArrayContext() {
    ...
    if (ctxt == null) {
      this
        ._child = ctxt = new JsonWriteContext(1, this, (this._dups == null) ? null : this._dups.child());
      return ctxt;
    } 
    return ctxt.reset(1);
  }
  ...
  public JsonWriteContext createChildArrayContext(Object currValue) {
    ...
    if (ctxt == null) {
      this
        ._child = ctxt = new JsonWriteContext(1, this, (this._dups == null) ? null : this._dups.child(), currValue);
      return ctxt;
    } 
  ...
  public JsonWriteContext createChildObjectContext() {
    ...
    if (ctxt == null) {
      this
        ._child = ctxt = new JsonWriteContext(2, this, (this._dups == null) ? null : this._dups.child());
      return ctxt;
    } 
    return ctxt.reset(2);
  }
  ...
  public JsonWriteContext createChildObjectContext(Object currValue) {
    ...
    if (ctxt == null) {
      this
        ._child = ctxt = new JsonWriteContext(2, this, (this._dups == null) ? null : this._dups.child(), currValue);
      return ctxt;
    } 
