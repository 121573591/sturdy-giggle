  ...
  static void validateMaxErrorTokenLength(int maxErrorTokenLength) throws IllegalArgumentException {
    if (maxErrorTokenLength < 0)
      throw new IllegalArgumentException(
          String.format("Value of maxErrorTokenLength (%d) cannot be negative", new Object[] { Integer.valueOf(maxErrorTokenLength) })); 
  }
  
  static void validateMaxRawContentLength(int maxRawContentLength) {
    if (maxRawContentLength < 0)
      throw new IllegalArgumentException(
          String.format("Value of maxRawContentLength (%d) cannot be negative", new Object[] { Integer.valueOf(maxRawContentLength) })); 
  }
}
