...
public final class ClassUtil {
  ...
  public static boolean isBogusClass(Class<?> cls) {
    return (cls == Void.class || cls == void.class || cls == NoClass.class);
  }
  ...
  public static Class<? extends Enum<?>> findEnumType(Enum<?> en) {
    return (Class)en.getDeclaringClass();
  }
  ...
  private static Method[] _failGetClassMethods(Class<?> cls, Throwable rootCause) throws IllegalArgumentException {
    throw new IllegalArgumentException(String.format("Failed on call to `getDeclaredMethods()` on class `%s`, problem: (%s) %s", new Object[] { cls
  ...
  public static Ctor[] getConstructors(Class<?> cls) {
    ...
    int len = arrayOfConstructor.length;
    Ctor[] result = new Ctor[len];
    for (int i = 0; i < len; i++)
      result[i] = new Ctor(arrayOfConstructor[i]); 
    return result;
  }
  ...
  private static class EnumTypeLocator {
    ...
    public Class<? extends Enum<?>> enumTypeFor(EnumSet<?> set) {
      if (this.enumSetTypeField != null)
        return (Class<? extends Enum<?>>)get(set, this.enumSetTypeField); 
    ...
    public Class<? extends Enum<?>> enumTypeFor(EnumMap<?, ?> set) {
      if (this.enumMapTypeField != null)
        return (Class<? extends Enum<?>>)get(set, this.enumMapTypeField); 
    ...
    private static Field locateField(Class<?> fromClass, String expectedName, Class<?> type) throws Exception {
      ...
      int i;
      byte b;
      for (arrayOfField1 = fields, i = arrayOfField1.length, b = 0; b < i; ) {
      ...
      throw new IllegalStateException(String.format("No field named '%s' in class '%s'", new Object[] { expectedName, fromClass
              .getName() }));
    }
  }
