...
public final class SerializerFactoryConfig implements Serializable {
  ...
  public SerializerFactoryConfig withAdditionalSerializers(Serializers additional) {
    ...
    Serializers[] all = (Serializers[])ArrayBuilders.insertInListNoDup((Object[])this._additionalSerializers, additional);
  ...
  public SerializerFactoryConfig withAdditionalKeySerializers(Serializers additional) {
    if (additional == null)
      throw new IllegalArgumentException("Cannot pass null Serializers"); 
    Serializers[] all = (Serializers[])ArrayBuilders.insertInListNoDup((Object[])this._additionalKeySerializers, additional);
  ...
  public SerializerFactoryConfig withSerializerModifier(BeanSerializerModifier modifier) {
    ...
    BeanSerializerModifier[] modifiers = (BeanSerializerModifier[])ArrayBuilders.insertInListNoDup((Object[])this._modifiers, modifier);
  ...
  public Iterable<Serializers> serializers() {
    return (Iterable<Serializers>)new ArrayIterator((Object[])this._additionalSerializers);
  }
  
  public Iterable<Serializers> keySerializers() {
    return (Iterable<Serializers>)new ArrayIterator((Object[])this._additionalKeySerializers);
  }
  
  public Iterable<BeanSerializerModifier> serializerModifiers() {
    return (Iterable<BeanSerializerModifier>)new ArrayIterator((Object[])this._modifiers);
  }
}
