...
public class DeserializerFactoryConfig implements Serializable {
  ...
  protected static final KeyDeserializers[] DEFAULT_KEY_DESERIALIZERS = new KeyDeserializers[] { (KeyDeserializers)new StdKeyDeserializers() };
  ...
  public DeserializerFactoryConfig withAdditionalDeserializers(Deserializers additional) {
    ...
    Deserializers[] all = (Deserializers[])ArrayBuilders.insertInListNoDup((Object[])this._additionalDeserializers, additional);
  ...
  public DeserializerFactoryConfig withAdditionalKeyDeserializers(KeyDeserializers additional) {
    ...
    KeyDeserializers[] all = (KeyDeserializers[])ArrayBuilders.insertInListNoDup((Object[])this._additionalKeyDeserializers, additional);
  ...
  public DeserializerFactoryConfig withDeserializerModifier(BeanDeserializerModifier modifier) {
    ...
    BeanDeserializerModifier[] all = (BeanDeserializerModifier[])ArrayBuilders.insertInListNoDup((Object[])this._modifiers, modifier);
  ...
  public DeserializerFactoryConfig withAbstractTypeResolver(AbstractTypeResolver resolver) {
    ...
    AbstractTypeResolver[] all = (AbstractTypeResolver[])ArrayBuilders.insertInListNoDup((Object[])this._abstractTypeResolvers, resolver);
  ...
  public DeserializerFactoryConfig withValueInstantiators(ValueInstantiators instantiators) {
    if (instantiators == null)
      throw new IllegalArgumentException("Cannot pass null resolver"); 
    ValueInstantiators[] all = (ValueInstantiators[])ArrayBuilders.insertInListNoDup((Object[])this._valueInstantiators, instantiators);
  ...
  public Iterable<Deserializers> deserializers() {
    return (Iterable<Deserializers>)new ArrayIterator((Object[])this._additionalDeserializers);
  }
  
  public Iterable<KeyDeserializers> keyDeserializers() {
    return (Iterable<KeyDeserializers>)new ArrayIterator((Object[])this._additionalKeyDeserializers);
  }
  
  public Iterable<BeanDeserializerModifier> deserializerModifiers() {
    return (Iterable<BeanDeserializerModifier>)new ArrayIterator((Object[])this._modifiers);
  }
  
  public Iterable<AbstractTypeResolver> abstractTypeResolvers() {
    return (Iterable<AbstractTypeResolver>)new ArrayIterator((Object[])this._abstractTypeResolvers);
  }
  
  public Iterable<ValueInstantiators> valueInstantiators() {
    return (Iterable<ValueInstantiators>)new ArrayIterator((Object[])this._valueInstantiators);
  }
}
