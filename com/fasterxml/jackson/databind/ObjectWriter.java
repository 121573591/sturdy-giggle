...
public class ObjectWriter implements Versioned, Serializable {
  ...
  public ObjectWriter with(DatatypeFeature feature) {
    return _new(this, (SerializationConfig)this._config.with(feature));
  }
  
  public ObjectWriter withFeatures(DatatypeFeature... features) {
    return _new(this, (SerializationConfig)this._config.withFeatures(features));
  }
  
  public ObjectWriter without(DatatypeFeature feature) {
    return _new(this, (SerializationConfig)this._config.without(feature));
  }
  
  public ObjectWriter withoutFeatures(DatatypeFeature... features) {
    return _new(this, (SerializationConfig)this._config.withoutFeatures(features));
  }
  ...
  public ObjectWriter withRootName(String rootName) {
    return _new(this, (SerializationConfig)this._config.withRootName(rootName));
  }
  ...
  public ObjectWriter with(Locale l) {
    return _new(this, (SerializationConfig)this._config.with(l));
  }
  
  public ObjectWriter with(TimeZone tz) {
    return _new(this, (SerializationConfig)this._config.with(tz));
  }
  
  public ObjectWriter with(Base64Variant b64variant) {
    return _new(this, (SerializationConfig)this._config.with(b64variant));
  }
  ...
  public ObjectWriter withAttributes(Map<?, ?> attrs) {
    return _new(this, (SerializationConfig)this._config.withAttributes(attrs));
  }
  
  public ObjectWriter withAttribute(Object key, Object value) {
    return _new(this, (SerializationConfig)this._config.withAttribute(key, value));
  }
  
  public ObjectWriter withoutAttribute(Object key) {
    return _new(this, (SerializationConfig)this._config.withoutAttribute(key));
  }
  ...
  public static final class Prefetch implements Serializable {
    ...
    public Prefetch forRootType(ObjectWriter parent, JavaType newType) {
      ...
      if (parent.isEnabled(SerializationFeature.EAGER_SERIALIZER_FETCH)) {
        ...
        } catch (DatabindException typeSer) {}
      } 
