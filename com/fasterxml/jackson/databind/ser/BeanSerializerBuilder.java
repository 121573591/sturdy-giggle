...
public class BeanSerializerBuilder {
  ...
  public void setFilteredProperties(BeanPropertyWriter[] properties) {
    if (properties != null && 
      properties.length != this._properties.size())
  ...
  public JsonSerializer<?> build() {
    ...
    if (this._typeId != null && 
      this._config.isEnabled(MapperFeature.CAN_OVERRIDE_ACCESS_MODIFIERS))
    ...
    if (this._properties == null || this._properties.isEmpty()) {
      ...
      properties = this._properties.<BeanPropertyWriter>toArray(new BeanPropertyWriter[this._properties.size()]);
    ...
    if (this._filteredProperties != null && 
      this._filteredProperties.length != this._properties.size())
    ...
    return (JsonSerializer<?>)new BeanSerializer(this._beanDesc.getType(), this, properties, this._filteredProperties);
  }
