...
public class AnyGetterWriter {
  ...
  public AnyGetterWriter(BeanProperty property, AnnotatedMember accessor, JsonSerializer<?> serializer) {
    ...
    this._serializer = (JsonSerializer)serializer;
    if (serializer instanceof MapSerializer)
      this._mapSerializer = (MapSerializer)serializer; 
  }
  
  public void fixAccess(SerializationConfig config) {
    this._accessor.fixAccess(config
  ...
  public void getAndSerialize(Object bean, JsonGenerator gen, SerializerProvider provider) throws Exception {
    ...
    if (!(value instanceof Map))
      provider.reportBadDefinition(this._property.getType(), String.format("Value returned by 'any-getter' %s() not java.util.Map but %s", new Object[] { this._accessor
  ...
  public void getAndFilter(Object bean, JsonGenerator gen, SerializerProvider provider, PropertyFilter filter) throws Exception {
    ...
    if (value == null)
      return; 
    if (!(value instanceof Map))
      provider.reportBadDefinition(this._property.getType(), 
          String.format("Value returned by 'any-getter' (%s()) not java.util.Map but %s", new Object[] { this._accessor.getName(), value.getClass().getName() })); 
    if (this._mapSerializer != null) {
