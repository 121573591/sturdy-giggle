...
public class SequenceWriter implements Versioned, Closeable, Flushable {
  ...
  private final JsonSerializer<Object> _findAndAddDynamic(Class<?> type) throws JsonMappingException {
    ...
    if (this._typeSerializer == null) {
      result = this._dynamicSerializers.findAndAddRootValueSerializer(type, (SerializerProvider)this._provider);
    } else {
      result = this._dynamicSerializers.addSerializer(type, (JsonSerializer)new TypeWrappedSerializer(this._typeSerializer, this._provider
