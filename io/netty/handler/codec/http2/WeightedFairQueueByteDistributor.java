...
public final class WeightedFairQueueByteDistributor implements StreamByteDistributor {
  ...
  private int distributeToChildren(int maxBytes, StreamByteDistributor.Writer writer, State state) throws Http2Exception {
    ...
    try {
      assert nextChildState == null || nextChildState.pseudoTimeToWrite >= childState.pseudoTimeToWrite : "nextChildState[" + nextChildState.streamId + "].pseudoTime(" + nextChildState.pseudoTimeToWrite + ") <  childState[" + childState.streamId + "].pseudoTime(" + childState.pseudoTimeToWrite + 41;
      ...
      if (this.children.remove(child.streamId) != null) {
        ...
        if (!child.children.isEmpty()) {
          ...
          do {
            ...
            dependency.weight = (short)(int)Math.max(1L, (dependency.weight * child.weight) / totalWeight);
