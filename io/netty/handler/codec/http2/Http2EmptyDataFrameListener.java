...
final class Http2EmptyDataFrameListener extends Http2FrameListenerDecorator {
  ...
  public int onDataRead(ChannelHandlerContext ctx, int streamId, ByteBuf data, int padding, boolean endOfStream) throws Http2Exception {
    if (endOfStream || data.isReadable()) {
      ...
      throw Http2Exception.connectionError(Http2Error.ENHANCE_YOUR_CALM, "Maximum number %d of empty data frames without end_of_stream flag received", new Object[] { Integer.valueOf(this.maxConsecutiveEmptyFrames) });
    } 
