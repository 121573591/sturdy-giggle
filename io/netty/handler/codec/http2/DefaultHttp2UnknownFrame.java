...
public final class DefaultHttp2UnknownFrame extends DefaultByteBufHolder implements Http2UnknownFrame {
  ...
  public String toString() {
    return StringUtil.simpleClassName(this) + "(frameType=" + this.frameType + ", stream=" + this.stream + ", flags=" + this.flags + ", content=" + 
      contentToString() + ')';
  }
  ...
  public boolean equals(Object o) {
    ...
    return ((this.stream == otherStream || (otherStream != null && otherStream.equals(this.stream))) && this.flags
      .equals(other.flags()) && this.frameType == other
      .frameType() && super
      .equals(other));
  }
