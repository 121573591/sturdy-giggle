...
public interface Http2Connection {
  ...
  void goAwayReceived(int paramInt, long paramLong, ByteBuf paramByteBuf) throws Http2Exception;
  
  boolean goAwaySent();
  
  boolean goAwaySent(int paramInt, long paramLong, ByteBuf paramByteBuf) throws Http2Exception;
