...
public final class HttpUtil {
  ...
  public static boolean isKeepAlive(HttpMessage message) {
    return (!message.headers().containsValue((CharSequence)HttpHeaderNames.CONNECTION, (CharSequence)HttpHeaderValues.CLOSE, true) && (message
      .protocolVersion().isKeepAliveDefault() || message
      .headers().containsValue((CharSequence)HttpHeaderNames.CONNECTION, (CharSequence)HttpHeaderValues.KEEP_ALIVE, true)));
  }
  ...
  public static boolean is100ContinueExpected(HttpMessage message) {
    return (isExpectHeaderValid(message) && message
      
      .headers().contains((CharSequence)HttpHeaderNames.EXPECT, (CharSequence)HttpHeaderValues.CONTINUE, true));
  }
  ...
  public static CharSequence getCharsetAsSequence(CharSequence contentTypeValue) {
    ...
    if (indexOfEncoding < contentTypeValue.length()) {
      ...
      int indexOfSemicolon = AsciiString.indexOfIgnoreCaseAscii(charsetCandidate, (CharSequence)SEMICOLON, 0);
