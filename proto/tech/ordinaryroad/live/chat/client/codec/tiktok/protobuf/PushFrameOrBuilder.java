...
public interface PushFrameOrBuilder extends
   ...
   */
  java.util.List<tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.HeadersList> 
      getHeadersListList();
  /**
   * <code>repeated .HeadersList headersList = 5;</code>
   */
  tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.HeadersList getHeadersList(int index);
  /**
   * <code>repeated .HeadersList headersList = 5;</code>
   */
   ...
   * <code>repeated .HeadersList headersList = 5;</code>
   */
  java.util.List<? extends tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.HeadersListOrBuilder> 
      getHeadersListOrBuilderList();
  /**
   * <code>repeated .HeadersList headersList = 5;</code>
   */
  tech.ordinaryroad.live.chat.client.codec.tiktok.protobuf.HeadersListOrBuilder getHeadersListOrBuilder(
      int index);
