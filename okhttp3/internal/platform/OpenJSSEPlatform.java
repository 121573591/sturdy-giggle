...
public final class OpenJSSEPlatform extends Platform {
  ...
  public SSLContext newSSLContext() {
    Intrinsics.checkNotNullExpressionValue(SSLContext.getInstance("TLSv1.3", this.provider), "getInstance(\"TLSv1.3\", provider)");
  ...
  public X509TrustManager platformTrustManager() {
    TrustManagerFactory factory = TrustManagerFactory.getInstance(
        TrustManagerFactory.getDefaultAlgorithm(), this.provider);
    ...
    if (!((trustManagers.length == 1 && trustManagers[0] instanceof X509TrustManager) ? 1 : 0)) {
      int $i$a$-check-OpenJSSEPlatform$platformTrustManager$1 = 0;
  ...
  public void configureTlsExtensions(@NotNull SSLSocket sslSocket, @Nullable String hostname, @NotNull List<? extends Protocol> protocols) {
    ...
    if (sslSocket instanceof SSLSocket) {
      ...
      if (sslParameters instanceof SSLParameters) {
        ...
        ((SSLParameters)sslParameters).setApplicationProtocols(thisCollection$iv.<String>toArray(new String[0]));
  ...
  public String getSelectedProtocol(@NotNull SSLSocket sslSocket) {
    ...
    return (sslSocket instanceof SSLSocket) ? (((protocol == null) ? true : Intrinsics.areEqual(protocol, "")) ? null : protocol) : super.getSelectedProtocol(sslSocket);
  }
  
  @Metadata(mv = {1, 8, 0}, k = 1, xi = 48, d1 = {"\000\034\n\002\030\002\n\002\020\000\n\002\b\002\n\002\030\002\n\002\b\002\n\002\020\013\n\002\b\004\b\003\030\0002\0020\001B\t\b\002¢\006\004\b\002\020\003J\017\020\005\032\004\030\0010\004¢\006\004\b\005\020\006R\027\020\b\032\0020\0078\006¢\006\f\n\004\b\b\020\t\032\004\b\b\020\n¨\006\013"}, d2 = {"Lokhttp3/internal/platform/OpenJSSEPlatform$Companion;", "", "<init>", "()V", "Lokhttp3/internal/platform/OpenJSSEPlatform;", "buildIfSupported", "()Lokhttp3/internal/platform/OpenJSSEPlatform;", "", "isSupported", "Z", "()Z", "okhttp"})
