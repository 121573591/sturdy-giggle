...
public final class SensitiveUtil {
  ...
  public static <T> T sensitiveFilter(T bean, boolean isGreedMatch, SensitiveProcessor sensitiveProcessor) {
    ...
    return (T)JSONUtil.toBean(sensitiveFilter(jsonText, isGreedMatch, sensitiveProcessor), c);
  }
  ...
  public static String sensitiveFilter(String text, boolean isGreedMatch, SensitiveProcessor sensitiveProcessor) {
    ...
    foundWordList.forEach(foundWord -> (FoundWord)foundWordMap.put(foundWord.getStartIndex(), foundWord));
    ...
    for (int i = 0; i < length; i++) {
      ...
      if (fw != null) {
        ...
        i = ((Integer)fw.getEndIndex()).intValue();
      } else {
