...
public enum Part {
  ...
  public int checkValue(int value) throws CronException {
    Assert.checkBetween(value, this.min, this.max, () -> new CronException("{} value {} out of range: [{} , {}]", new Object[] { name(), Integer.valueOf(value), Integer.valueOf(this.min), Integer.valueOf(this.max) }));
    return value;
  }
