...
public class ExcelUtil {
  ...
  public static ExcelReader getReader(String bookFilePath, int sheetIndex) {
    try {
      ...
      throw new DependencyException((Throwable)ObjectUtil.defaultIfNull(e.getCause(), e), "You need to add dependency of 'poi-ooxml' to your project, and version >= 4.1.2", new Object[0]);
    } 
  }
  ...
  public static CellLocation toLocation(String locationRef) {
    ...
    int y = ReUtil.getFirstNumber(locationRef).intValue() - 1;
