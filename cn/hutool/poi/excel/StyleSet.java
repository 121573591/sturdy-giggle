...
public class StyleSet implements Serializable {
  ...
  public CellStyle getStyleByValueType(Object value, boolean isHeader) {
    ...
    if (value instanceof java.util.Date || value instanceof java.time.temporal.TemporalAccessor || value instanceof java.util.Calendar) {
      if (null != this.cellStyleForDate)
        style = this.cellStyleForDate; 
    } else if (value instanceof Number) {
      if ((value instanceof Double || value instanceof Float || value instanceof java.math.BigDecimal) && null != this.cellStyleForNumber)
        style = this.cellStyleForNumber; 
    } else if (value instanceof org.apache.poi.ss.usermodel.Hyperlink) {
