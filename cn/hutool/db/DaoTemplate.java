...
public class DaoTemplate {
  ...
  public <T> int del(T pk) throws SQLException {
    if (pk == null)
      return 0; 
    return del(Entity.create(this.tableName).set(this.primaryKeyField, pk));
  }
  
  public <T> int del(String field, T value) throws SQLException {
    if (StrUtil.isBlank(field))
      return 0; 
    return del(Entity.create(this.tableName).set(field, value));
  }
  ...
  public <T> Entity get(String field, T value) throws SQLException {
    return get(Entity.create(this.tableName).set(field, value));
  }
  ...
  public <T> List<Entity> find(String field, T value) throws SQLException {
    return find(Entity.create(this.tableName).set(field, value));
  }
