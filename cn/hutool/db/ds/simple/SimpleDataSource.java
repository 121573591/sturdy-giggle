...
public class SimpleDataSource extends AbstractDataSource {
  ...
  public SimpleDataSource(Setting setting, String group) {
    ...
    init(config
        .getAndRemoveStr(DSFactory.KEY_ALIAS_URL), config
        .getAndRemoveStr(DSFactory.KEY_ALIAS_USER), config
        .getAndRemoveStr(DSFactory.KEY_ALIAS_PASSWORD), config
        .getAndRemoveStr(DSFactory.KEY_ALIAS_DRIVER));
    this.connProps = (Properties)config.getProps("");
  }
  ...
  public void init(String url, String user, String pass, String driver) {
    ...
    try {
      ...
      throw new DbRuntimeException(e, "Get jdbc driver [{}] error!", new Object[] { driver });
    } 
    this.url = url;
    this.user = user;
    this.pass = pass;
  ...
  public Connection getConnection() throws SQLException {
    ...
    return DriverManager.getConnection(this.url, (Properties)info);
  }
