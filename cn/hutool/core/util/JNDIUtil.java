...
public class JNDIUtil {
  public static InitialDirContext createInitialDirContext(Map<String, String> environment) {
    try {
      ...
      return new InitialDirContext((Hashtable<?, ?>)Convert.convert(Hashtable.class, environment));
  ...
  public static InitialContext createInitialContext(Map<String, String> environment) {
    try {
      ...
      return new InitialContext((Hashtable<?, ?>)Convert.convert(Hashtable.class, environment));
    } catch (NamingException e) {
      throw new UtilException(e);
    } 
  }
