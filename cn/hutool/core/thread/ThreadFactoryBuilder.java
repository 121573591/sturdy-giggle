...
public class ThreadFactoryBuilder implements Builder<ThreadFactory> {
  ...
  public ThreadFactoryBuilder setPriority(int priority) {
    if (priority < 1)
      throw new IllegalArgumentException(StrUtil.format("Thread priority ({}) must be >= {}", new Object[] { Integer.valueOf(priority), Integer.valueOf(1) })); 
    if (priority > 10)
      throw new IllegalArgumentException(StrUtil.format("Thread priority ({}) must be <= {}", new Object[] { Integer.valueOf(priority), Integer.valueOf(10) })); 
