...
public class FastDatePrinter extends AbstractDateBasic implements DatePrinter {
  ...
  private void init() {
    ...
    this.rules = rulesList.<Rule>toArray(new Rule[0]);
    int len = 0;
  ...
  private static final ConcurrentMap<TimeZoneDisplayKey, String> C_TIME_ZONE_DISPLAY_CACHE = (ConcurrentMap<TimeZoneDisplayKey, String>)new SafeConcurrentHashMap(7);
