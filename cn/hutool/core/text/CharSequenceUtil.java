...
public class CharSequenceUtil {
  ...
  public static boolean containsAll(CharSequence str, CharSequence... testChars) {
    if (isBlank(str) || ArrayUtil.isEmpty((Object[])testChars))
      return false; 
  ...
  public static String removeAllLineBreaks(CharSequence str) {
    return removeAll(str, new char[] { '\r', '\n' });
  }
  ...
  public static String cleanBlank(CharSequence str) {
    return filter(str, c -> (false == CharUtil.isBlankChar(c.charValue())));
  }
  ...
  public static String addPrefixIfNot(CharSequence str, CharSequence prefix) {
    return prependIfMissing(str, prefix, new CharSequence[] { prefix });
  }
  
  public static String addSuffixIfNot(CharSequence str, CharSequence suffix) {
    return appendIfMissing(str, suffix, new CharSequence[] { suffix });
  }
  
  public static long[] splitToLong(CharSequence str, char separator) {
    return (long[])Convert.convert(long[].class, splitTrim(str, separator));
  }
  ...
  public static int[] splitToInt(CharSequence str, char separator) {
    return (int[])Convert.convert(int[].class, splitTrim(str, separator));
  }
  ...
  public static String[] subBetweenAll(CharSequence str, CharSequence prefix, CharSequence suffix) {
    if (hasEmpty(new CharSequence[] { str, prefix, suffix }) || false == contains(str, prefix))
      return new String[0]; 
  ...
  public static boolean isWrap(CharSequence str, String prefix, String suffix) {
    if (ArrayUtil.hasNull((Object[])new CharSequence[] { str, prefix, suffix }))
      return false; 
    String str2 = str.toString();
  ...
  public static <T extends CharSequence> T firstNonNull(T... strs) {
    return (T)ArrayUtil.firstNonNull((Object[])strs);
  }
  
  public static <T extends CharSequence> T firstNonEmpty(T... strs) {
    return (T)ArrayUtil.firstMatch(CharSequenceUtil::isNotEmpty, (Object[])strs);
  }
  
  public static <T extends CharSequence> T firstNonBlank(T... strs) {
    return (T)ArrayUtil.firstMatch(CharSequenceUtil::isNotBlank, (Object[])strs);
  }
  ...
  public static String brief(CharSequence str, int maxLength) {
    ...
    String str2 = str.toString();
    return format("{}...{}", new Object[] { str2
          .substring(0, preLength), str2
          .substring(strLength - suffixLength) });
  }
  ...
  public static boolean isAllCharMatch(CharSequence value, Matcher<Character> matcher) {
    ...
    for (int i = value.length(); --i >= 0;) {
      if (false == matcher.match(Character.valueOf(value.charAt(i))))
        return false; 
    } 
    return true;
  }
