...
public class TransSpliterator<F, T> implements Spliterator<T> {
  ...
  public boolean tryAdvance(Consumer<? super T> action) {
    return this.fromSpliterator.tryAdvance(fromElement -> action.accept(this.function.apply((F)fromElement)));
  }
  
  public void forEachRemaining(Consumer<? super T> action) {
    this.fromSpliterator.forEachRemaining(fromElement -> action.accept(this.function.apply((F)fromElement)));
  }
