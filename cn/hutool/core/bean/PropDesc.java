...
public class PropDesc {
  ...
  public Object getValue(Object bean, Type targetType, boolean ignoreError) {
    ...
    try {
      ...
      if (false == ignoreError)
        throw new BeanException(e, "Get value of [{}] error!", new Object[] { getFieldName() }); 
    } 
  ...
  public PropDesc setValue(Object bean, Object value, boolean ignoreNull, boolean ignoreError, boolean override) {
    ...
    if (null != value || false == ignoreNull)
      try {
        ...
        if (false == ignoreError)
          throw new BeanException(e, "Set value of [{}] error!", new Object[] { getFieldName() }); 
      }  
    return this;
  }
  ...
  private boolean isTransientForGet() {
    boolean isTransient = ModifierUtil.hasModifier(this.field, new ModifierUtil.ModifierType[] { ModifierUtil.ModifierType.TRANSIENT });
    if (false == isTransient && null != this.getter) {
      isTransient = ModifierUtil.hasModifier(this.getter, new ModifierUtil.ModifierType[] { ModifierUtil.ModifierType.TRANSIENT });
  ...
  private boolean isTransientForSet() {
    ...
    if (false == isTransient && null != this.setter) {
      isTransient = ModifierUtil.hasModifier(this.setter, new ModifierUtil.ModifierType[] { ModifierUtil.ModifierType.TRANSIENT });
      if (false == isTransient)
