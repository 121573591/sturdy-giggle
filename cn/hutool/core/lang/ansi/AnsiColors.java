...
public final class AnsiColors {
  ...
  static {
    ...
    colorMap.put(new AnsiColorWrapper(AnsiColor.BLACK.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(0)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.RED.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(11141120)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.GREEN.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(43520)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.YELLOW.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(11162880)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.BLUE.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(170)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.MAGENTA.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(11141290)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.CYAN.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(43690)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.WHITE.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(11184810)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.BRIGHT_BLACK.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(5592405)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.BRIGHT_RED.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(16733525)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.BRIGHT_GREEN.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(5635840)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.BRIGHT_YELLOW.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(16777045)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.BRIGHT_BLUE.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(5592575)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.BRIGHT_MAGENTA.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(16733695)));
    colorMap.put(new AnsiColorWrapper(AnsiColor.BRIGHT_CYAN.getCode(), BitDepth.FOUR), new LabColor(Integer.valueOf(5636095)));
    colorMap.put(new AnsiColorWrapper(97, BitDepth.FOUR), new LabColor(Integer.valueOf(16777215)));
    ANSI_COLOR_MAP = Collections.unmodifiableMap(colorMap);
  }
  
  private static final int[] ANSI_8BIT_COLOR_CODE_LOOKUP = new int[] { 
