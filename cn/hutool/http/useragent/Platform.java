...
public class Platform extends UserAgentInfo {
  ...
  public static final List<Platform> mobilePlatforms = CollUtil.newArrayList((Object[])new Platform[] { WINDOWS_PHONE, IPAD, IPOD, IPHONE, new Platform("Android", "XiaoMi|MI\\s+"), ANDROID, GOOGLE_TV, new Platform("htcFlyer", "htc_flyer"), new Platform("Symbian", "symbian(os)?"), new Platform("Blackberry", "blackberry") });
  
  public static final List<Platform> desktopPlatforms = CollUtil.newArrayList((Object[])new Platform[] { new Platform("Windows", "windows"), new Platform("Mac", "(macintosh|darwin)"), new Platform("Linux", "linux"), new Platform("Wii", "wii"), new Platform("Playstation", "playstation"), new Platform("Java", "java") });
