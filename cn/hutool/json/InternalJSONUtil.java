  ...
  static Map<String, Object> createRawMap(int capacity, JSONConfig config) {
    ...
    if (config.isIgnoreCase()) {
      if (null != keyComparator) {
        CaseInsensitiveTreeMap caseInsensitiveTreeMap = new CaseInsensitiveTreeMap(keyComparator);
      } else {
        CaseInsensitiveLinkedMap caseInsensitiveLinkedMap = new CaseInsensitiveLinkedMap(capacity);
      } 
