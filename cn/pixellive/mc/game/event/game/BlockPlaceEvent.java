...
public final class BlockPlaceEvent {
  ...
  public BlockPlaceEvent(@NotNull class_1750 paramclass_1750, @Nullable class_1269 paramclass_1269) {
    this.context = paramclass_1750;
    this.result = paramclass_1269;
  }
  ...
  public final void setResult(@Nullable class_1269 paramclass_1269) {
    this.result = paramclass_1269;
  }
  
  static {
    byte[] arrayOfByte1 = "m'yãÆ YeºÅ[m\021\t\030QªáZ\022õÚ\004MC/ÏÅá\037î/ÈíIºtØ7O".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "\027e3üì¥Â".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)-1109697815;
      if (i == j) {
