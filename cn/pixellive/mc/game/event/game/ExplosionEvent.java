...
public final class ExplosionEvent extends CancellableEvent {
  @NotNull
  ...
  public ExplosionEvent(@NotNull class_1927 paramclass_1927, boolean paramBoolean) {
    this.explosion = paramclass_1927;
    this.particles = paramBoolean;
  }
  ...
  static {
    byte[] arrayOfByte1 = "\0004\036fÍ#³w÷¬m8>ä0K:oÐê­®~ñÀTQ\036 j\030Ìpw¢\nÅ×.\b\001ïÄ{".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "ãi@<5~òï".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)-2129694907;
      if (i == j) {
