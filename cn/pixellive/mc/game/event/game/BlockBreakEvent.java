...
public final class BlockBreakEvent {
  ...
  public BlockBreakEvent(@NotNull class_1657 paramclass_1657, @NotNull class_1937 paramclass_1937, @NotNull class_2338 paramclass_2338, @NotNull class_2248 paramclass_2248) {
    this.player = paramclass_1657;
    this.world = paramclass_1937;
    this.pos = paramclass_2338;
    this.block = paramclass_2248;
  }
  ...
  static {
    byte[] arrayOfByte1 = "÷I»\006ê¸dù°©\fÕYä\004,É`ÄGãÛ[³åD³[y·T>«_ª,k³L¡nÅùSbÞf¸æùFMpg*`ÿ,\024nY".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "ý=]=\n%".getBytes("ISO_8859_1");
    int i = 0;
