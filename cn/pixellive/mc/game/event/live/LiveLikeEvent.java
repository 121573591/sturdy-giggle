...
public final class LiveLikeEvent {
  ...
  public LiveLikeEvent(@NotNull String paramString, int paramInt) {
  ...
  static {
    byte[] arrayOfByte1 = "\003¶qÄ4BWÃÊ¦\fg'ÌÎ¶%:!fE£\030Àª\001\034\030~{àñ'ÿÑíñUe47\b".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "ºEk/!¸ù".getBytes("ISO_8859_1");
    int i = 0;
