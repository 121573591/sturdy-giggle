...
public final class LiveGiftEvent {
  ...
  public LiveGiftEvent(@NotNull String paramString1, @NotNull String paramString2, int paramInt, @NotNull String paramString3, @NotNull String paramString4) {
    this.username = paramString1;
    this.giftName = paramString2;
    this.giftCount = paramInt;
  ...
  public final void setGiftCount(int paramInt) {
    this.giftCount = paramInt;
  }
  ...
  static {
    byte[] arrayOfByte1 = "#&Ã5Ã/\025Ú#º\fÑL¸c$×T\022³H¦'9Ç?ì\032õ>YØ%[xz­UJ=kÉ¯ÏËÌ\005c+Ûån\004SvÂøg¥Úør÷".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "w²]À][\f".getBytes("ISO_8859_1");
    int i = 0;
