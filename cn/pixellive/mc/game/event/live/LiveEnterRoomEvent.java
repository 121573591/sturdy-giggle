...
public final class LiveEnterRoomEvent {
  ...
  public LiveEnterRoomEvent(@NotNull String paramString) {
  ...
  static {
    byte[] arrayOfByte1 = "9ÝÄß«éJ\036\006!ï\r«¹öf¸æ*âìäd6§¾cÁ\030ßÉq37//ÿ".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "Vò]&H¯".getBytes("ISO_8859_1");
    int i = 0;
