...
public final class LiveChatEvent {
  ...
  public LiveChatEvent(@NotNull String paramString1, @NotNull String paramString2) {
  ...
  static {
    byte[] arrayOfByte1 = "õ;¶U2\005eõ28\035­wPó£tb\021A{4.\nÑ<Ùºâ'¡\006Q³J\n/z³\t{U§\0061Ðm".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "ff;XäË".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)1127000064;
      if (i == j) {
