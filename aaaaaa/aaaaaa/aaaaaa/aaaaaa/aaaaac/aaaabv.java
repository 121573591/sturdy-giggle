...
public final class aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv {
  @NotNull
  ...
  public aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv(@NotNull String paramString1, int paramInt, @Nullable class_1299<? extends class_1308> paramclass_1299, boolean paramBoolean1, boolean paramBoolean2, @Nullable String paramString2, @Nullable Function3<? super class_3218, ? super class_243, ? super String, ? extends class_1308> paramFunction3) {
    this.我草你怎么反编译我模组aaaaaa = paramString1;
    this.我草你怎么反编译我模组aaaaab = paramInt;
    this.我草你怎么反编译我模组aaaaac = paramclass_1299;
    this.我草你怎么反编译我模组aaaaad = paramBoolean1;
    this.我草你怎么反编译我模组aaaaae = paramBoolean2;
    this.我草你怎么反编译我模组aaaaaf = paramString2;
    this.我草你怎么反编译我模组aaaaag = (Function3)paramFunction3;
  }
  ...
  @NotNull
  public final aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv 你为什么要破解我的代码aaaaao(@NotNull String paramString1, int paramInt, @Nullable class_1299<? extends class_1308> paramclass_1299, boolean paramBoolean1, boolean paramBoolean2, @Nullable String paramString2, @Nullable Function3<? super class_3218, ? super class_243, ? super String, ? extends class_1308> paramFunction3) {
    Intrinsics.checkNotNullParameter(paramString1, (String)aaaaaq((char)-475594752));
    return new aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv(paramString1, paramInt, paramclass_1299, paramBoolean1, paramBoolean2, paramString2, paramFunction3);
  }
  ...
  public boolean equals(@Nullable Object paramObject) {
    if (this == paramObject)
      return true; 
    if (!(paramObject instanceof aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv))
      return false; 
    aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv1 = (aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv)paramObject;
    return !Intrinsics.areEqual(this.我草你怎么反编译我模组aaaaaa, aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv1.我草你怎么反编译我模组aaaaaa) ? false : ((this.我草你怎么反编译我模组aaaaab != aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv1.我草你怎么反编译我模组aaaaab) ? false : (!Intrinsics.areEqual(this.我草你怎么反编译我模组aaaaac, aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv1.我草你怎么反编译我模组aaaaac) ? false : ((this.我草你怎么反编译我模组aaaaad != aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv1.我草你怎么反编译我模组aaaaad) ? false : ((this.我草你怎么反编译我模组aaaaae != aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv1.我草你怎么反编译我模组aaaaae) ? false : (!Intrinsics.areEqual(this.我草你怎么反编译我模组aaaaaf, aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv1.我草你怎么反编译我模组aaaaaf) ? false : (!!Intrinsics.areEqual(this.我草你怎么反编译我模组aaaaag, aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaabv1.我草你怎么反编译我模组aaaaag)))))));
  }
  
  static {
    byte[] arrayOfByte1 = "\025é©æFf|4°\037¨ÿ\033,²g=k÷¿ß+s\005`\001ú\n\byé\t\032·å".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "Cª\026bM=Jø".getBytes("ISO_8859_1");
    int i = 0;
