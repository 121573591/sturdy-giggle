...
final class aaaabl extends Lambda implements Function1<Map.Entry<UUID, Long>, Boolean> {
  static Object aaaaaa;
  
  aaaabl(class_3218 paramclass_3218) {
    super(1);
  }
  
  @NotNull
  public final Boolean 你为什么要破解我的代码aaaaak(@NotNull Map.Entry<UUID, Long> paramEntry) {
    Intrinsics.checkNotNullParameter(paramEntry, (String)aaaaaa((char)-1981808640));
    UUID uUID = paramEntry.getKey();
    return Boolean.valueOf((this.我草你怎么反编译我模组aaaaaz.method_14190(uUID) == null));
  }
  
  static {
    byte[] arrayOfByte1 = "lãíáöÒ_¡Ô\030ß\037X\035³ìú\n\005òáº\027&5\"\016ÌÊ\023Á+Ü*(ïÿXÒ¯g#Þè²BsZhý\\ò¼©¥M@! +¢ ®".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "\026\006lÒÿÆQ".getBytes("ISO_8859_1");
    int i = 0;
