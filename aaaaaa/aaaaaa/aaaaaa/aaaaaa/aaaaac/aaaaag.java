...
public final class aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaaag {
  @NotNull
  ...
  public aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaaag(@NotNull String paramString1, @NotNull String paramString2) {
    this.我草你怎么反编译我模组aaaaaa = paramString1;
    this.我草你怎么反编译我模组aaaaab = paramString2;
  }
  ...
  @NotNull
  public final aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaaag 你为什么要破解我的代码aaaaae(@NotNull String paramString1, @NotNull String paramString2) {
    Intrinsics.checkNotNullParameter(paramString1, (String)aaaaag((char)1730805760));
    Intrinsics.checkNotNullParameter(paramString2, (String)aaaaag((char)1339752449));
    return new aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaaag(paramString1, paramString2);
  }
  ...
  public boolean equals(@Nullable Object paramObject) {
    if (this == paramObject)
      return true; 
    if (!(paramObject instanceof aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaaag))
      return false; 
    aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaaag aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaaag1 = (aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaac/aaaaag)paramObject;
