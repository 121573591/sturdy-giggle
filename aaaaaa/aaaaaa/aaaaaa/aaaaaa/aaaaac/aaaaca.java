...
final class aaaaca extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
  int 我草你怎么反编译我模组aaaaaf;
  
  static Object aaaaaa;
  
  aaaaca(Continuation<? super aaaaca> paramContinuation) {
  ...
  public final Object invokeSuspend(@NotNull Object paramObject) {
    ...
    //   8: tableswitch default -> 119, 0 -> 32, 1 -> 110
    //   32: aload_1
    //   33: invokestatic throwOnFailure : (Ljava/lang/Object;)V
    //   36: nop
    //   37: invokestatic 你为什么要破解我的代码aaaakv : ()Z
    //   40: ifne -> 88
    //   43: invokestatic 你为什么要破解我的代码aaaakw : ()Z
    //   46: ifne -> 88
    //   49: invokestatic 你为什么要破解我的代码aaaakx : ()Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    //   67: iconst_0
    //   68: ifeq -> 88
    //   71: invokestatic 你为什么要破解我的代码aaaakx : ()Ljava/util/concurrent/ConcurrentLinkedQueue;
    //   74: invokevirtual poll : ()Ljava/lang/Object;
    ...
    //   95: aload_0
    //   96: iconst_1
    //   97: putfield 我草你怎么反编译我模组aaaaaf : I
    //   100: invokestatic delay : (JLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    //   103: dup
    //   104: aload_2
    //   105: if_acmpne -> 115
    //   108: aload_2
    ...
    //   123: ldc 1211957248
    //   125: i2c
    //   126: invokestatic aaaaaa : (C)Ljava/lang/Object;
  ...
  public final Continuation<Unit> create(@Nullable Object paramObject, @NotNull Continuation<?> paramContinuation) {
    return (Continuation<Unit>)new aaaaca((Continuation)paramContinuation);
  }
  ...
  public final Object 你为什么要破解我的代码aaaaab(@NotNull CoroutineScope paramCoroutineScope, @Nullable Continuation<? super Unit> paramContinuation) {
    return ((aaaaca)create(paramCoroutineScope, paramContinuation)).invokeSuspend(Unit.INSTANCE);
  }
  
  static {
    byte[] arrayOfByte1 = "ÿ\bï]¤+éîTt8î%­LöFÔEzòæ4®o]ðõ¥ò¾ô\005jÒÛT\026ÄJ¶~¤À5\"Ý\033³¥\036ù\003\006çp¥F\020²\023nÁ\bþ£<)@5áOìîb".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "·yÏÓ©Î¥¡".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)1026011240;
      if (i == j) {
