...
public final class aaaacm extends TimerTask {
  private int 我草你怎么反编译我模组aaaaaI;
  ...
  public final void 你为什么要破解我的代码aaaaaq(int paramInt) {
    this.我草你怎么反编译我模组aaaaaI = paramInt;
  }
  
  public void run() {
    aaaaap.我草你怎么反编译我模组aaaaaa.你为什么要破解我的代码aaaaaa().你为什么要破解我的代码aaaaac((String)aaaaar((char)-1858732032));
    this.我草你怎么反编译我模组aaaaaI++;
    if (this.我草你怎么反编译我模组aaaaaI > 1000 || aaaaaN.我草你怎么反编译我模组aaaack.你为什么要破解我的代码aaaafg() <= 0L)
      cancel(); 
  }
  
  static {
    byte[] arrayOfByte1 = "ý¢µzâ¨Å\026ÒÔM¼Ä{Ï[´L~½j?\032Á´£vR8¢~Ó¡èeJoE¦²AüÂ$¯:\020tQÑþ¬¹^kmÃÊp\004¶".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "Ø¥ÓlCI".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)1433644790;
      if (i == j) {
