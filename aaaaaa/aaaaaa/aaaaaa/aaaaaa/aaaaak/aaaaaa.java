...
public final class aaaaaa {
  ...
  public final void 你为什么要破解我的代码aaaaaa() {
    HudRenderCallback.EVENT.register(aaaaaa::你为什么要破解我的代码aaaaab);
  }
  
  private static final void 你为什么要破解我的代码aaaaab(class_332 paramclass_332, class_9779 paramclass_9779) {
    Intrinsics.checkNotNullParameter(paramclass_332, (String)aaaaac((char)1328087040));
    Intrinsics.checkNotNullParameter(paramclass_9779, (String)aaaaac((char)-429129727));
    aaaaac.我草你怎么反编译我模组aaaaaa.你为什么要破解我的代码aaaaac(paramclass_332);
    aaaaae.我草你怎么反编译我模组aaaaaa.你为什么要破解我的代码aaaaab(paramclass_332);
  }
  
  static {
    byte[] arrayOfByte1 = "Bå»'Öì´lÓ\030iI¡a§ëòÉ)ZÔy{âïÂßö!vA$îÝâÊÐ¶ÝÇSsr°Sb2O¿ÖDa_".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "3!ìP¥D(".getBytes("ISO_8859_1");
    int i = 0;
  ...
  private static Object aaaaac(char paramChar) {
