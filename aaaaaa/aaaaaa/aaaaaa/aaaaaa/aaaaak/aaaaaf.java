...
public final class aaaaaf extends class_927<aaaaaa, class_574<aaaaaa>> {
  static Object aaaaaa;
  
  public aaaaaf(@NotNull class_5617.class_5618 paramclass_5618) {
    super(paramclass_5618, (class_583)new class_574(paramclass_5618.method_32167(class_5602.field_27608)), 0.7F);
  }
  
  @NotNull
  public class_2960 你为什么要破解我的代码aaaaaa(@NotNull aaaaaa paramaaaaaa) {
    Intrinsics.checkNotNullParameter(paramaaaaaa, (String)aaaaab((char)1985937409));
    class_2960 class_2960 = paramaaaaaa.你为什么要破解我的代码aaaaab();
    Intrinsics.checkNotNull(class_2960);
    return class_2960;
  }
  
  static {
    byte[] arrayOfByte1 = "4ÿÓLR\\âµ,/«»\016\030Qf/¿Ê6ÈÜá\006\020!ýg$\033=\005±¬¡\007YE\"n\035Î\031c\037\032}Ð".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "\030\f\006&/Ô".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)2136673634;
      if (i == j) {
