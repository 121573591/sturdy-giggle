...
final class aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaak/aaaaab {
  ...
  public aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaak/aaaaab(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3, @Nullable String paramString) {
    this.我草你怎么反编译我模组aaaaaa = paramInt;
    this.我草你怎么反编译我模组aaaaab = paramFloat1;
    this.我草你怎么反编译我模组aaaaac = paramFloat2;
    this.我草你怎么反编译我模组aaaaad = paramFloat3;
  ...
  @NotNull
  public final aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaak/aaaaab 你为什么要破解我的代码aaaaak(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3, @Nullable String paramString) {
    return new aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaak/aaaaab(paramInt, paramFloat1, paramFloat2, paramFloat3, paramString);
  }
  ...
  public boolean equals(@Nullable Object paramObject) {
    if (this == paramObject)
      return true; 
    if (!(paramObject instanceof aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaak/aaaaab))
      return false; 
    aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaak/aaaaab aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaak/aaaaab1 = (aaaaaa/aaaaaa/aaaaaa/aaaaaa/aaaaak/aaaaab)paramObject;
