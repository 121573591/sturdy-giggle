...
public final class aaaaab {
  ...
  public aaaaab(@NotNull MinecraftServer paramMinecraftServer) {
  ...
  static {
    byte[] arrayOfByte1 = "¡;ÔéFS½Rú4$\036J`³ØÖW]¶F\\ìB»´X94ãùg\r|8Î\bÛm\001LíSx$".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "¹\bÁYU7É".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)1150114165;
      if (i == j) {
