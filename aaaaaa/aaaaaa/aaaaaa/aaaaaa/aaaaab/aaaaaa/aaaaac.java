...
public final class aaaaac {
  ...
  public aaaaac(@NotNull MinecraftServer paramMinecraftServer) {}
  
  static {
    byte[] arrayOfByte1 = "©Ç¬\bR\024ë×æö÷yé\035{ÓÕçLTãà¾Ìì\"½\017 &úË+ÇtQ\001)as¢".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "Ä>\026¸@#8".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)-1719225546;
      if (i == j) {
