...
public final class aaaaad {
  ...
  public aaaaad(@NotNull MinecraftServer paramMinecraftServer, @NotNull class_1937 paramclass_1937) {}
  
  static {
    byte[] arrayOfByte1 = "?E\034%5rÑrï'Bz¨êBÏèÇ\006*¬UMË©Ì\r68AuÎ\026:;\005]\001êõû\021".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "»\021\fe1¤".getBytes("ISO_8859_1");
    int i = 0;
