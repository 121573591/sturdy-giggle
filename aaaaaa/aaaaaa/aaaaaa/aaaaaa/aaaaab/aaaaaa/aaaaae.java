...
public final class aaaaae {
  @NotNull
  private final MinecraftServer 我草你怎么反编译我模组aaaaaa;
  
  static Object aaaaab;
  
  public aaaaae(@NotNull MinecraftServer paramMinecraftServer) {
    this.我草你怎么反编译我模组aaaaaa = paramMinecraftServer;
  }
  
  @NotNull
  public final MinecraftServer 你为什么要破解我的代码aaaaaa() {
    return this.我草你怎么反编译我模组aaaaaa;
  }
  
  static {
    byte[] arrayOfByte1 = "\022Ð¿¼4PÏ3|Û\021åsì\013gÁG>Wb§_ÃÚKå\021<Ü; ¤ëÊ*Ý\001ce\\çØ[".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "¦ärV\005".getBytes("ISO_8859_1");
    int i = 0;
