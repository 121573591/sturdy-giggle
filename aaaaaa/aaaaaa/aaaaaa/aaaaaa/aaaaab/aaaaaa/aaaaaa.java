...
public final class aaaaaa {
  ...
  public aaaaaa(@NotNull MinecraftServer paramMinecraftServer) {}
  
  static {
    byte[] arrayOfByte1 = "*¬i^\fªOçTeþnN*°îÛÒP¨AxÑLß\017\\g8ïúl2Ìÿ".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "p¸\001ü|È{".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)1103042963;
      if (i == j) {
