...
public final class aaaaaf {
  @NotNull
  private final class_3244 我草你怎么反编译我模组aaaaaa;
  
  @NotNull
  private final PacketSender 我草你怎么反编译我模组aaaaab;
  
  @NotNull
  private final MinecraftServer 我草你怎么反编译我模组aaaaac;
  
  static Object aaaaad;
  
  public aaaaaf(@NotNull class_3244 paramclass_3244, @NotNull PacketSender paramPacketSender, @NotNull MinecraftServer paramMinecraftServer) {
    this.我草你怎么反编译我模组aaaaaa = paramclass_3244;
    this.我草你怎么反编译我模组aaaaab = paramPacketSender;
    this.我草你怎么反编译我模组aaaaac = paramMinecraftServer;
  }
  
  @NotNull
  public final class_3244 你为什么要破解我的代码aaaaaa() {
    return this.我草你怎么反编译我模组aaaaaa;
  }
  
  @NotNull
  public final PacketSender 你为什么要破解我的代码aaaaab() {
    return this.我草你怎么反编译我模组aaaaab;
  }
  
  @NotNull
  public final MinecraftServer 你为什么要破解我的代码aaaaac() {
    return this.我草你怎么反编译我模组aaaaac;
  }
  
  static {
    byte[] arrayOfByte1 = "\033:~5l·ú6mø9N\020q\030âò_±9ÜgPÅÕm\031³Z4ÄÆâM)\005ªwh\b¹äðñ!\035mÙ%¿ÙnIó$Jï".getBytes("ISO_8859_1");
    byte[] arrayOfByte2 = "\032¨\f\føñ1".getBytes("ISO_8859_1");
    int i = 0;
    ...
    while (true) {
      ...
      arrayOfByte1[i++] = (byte)-1822909997;
      if (i == j) {
